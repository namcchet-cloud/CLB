import { VERSION } from './core/build.js?v=6.1.1';
import { start, near, features, issues, report } from './core/runtime.js?v=6.1.1';
import { initI18n } from './core/i18n.js?v=6.1.1';
import { initMotion } from './features/motion.js?v=6.1.1';
import { initNavigation } from './features/navigation.js?v=6.1.1';
...
try {
  ...
  lazy('gallery', document.getElementById('gallery'), async () => (await import('./features/gallery.js?v=6.1.1&r=740')).initGallery(content));
