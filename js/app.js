import { VERSION } from './core/build.js?v=7.0.4';
import { start, near, features, issues, report } from './core/runtime.js?v=7.0.4';
import { initI18n } from './core/i18n.js?v=7.0.4';
import { initMotion } from './features/motion.js?v=7.0.4';
import { initNavigation } from './features/navigation.js?v=7.0.4';
import { initComicDecor } from './features/comic-decor.js?v=7.0.4';
import { initLivingSketchbook } from './features/living-sketchbook.js?v=7.0.4';
...
try {
  ...
  lazy('gallery', document.getElementById('gallery'), async () => (await import('./features/gallery.js?v=7.0.4')).initGallery(content));
  lazy('music', document.getElementById('playlist'), async () => (await import('./features/music/index.js?v=7.0.4')).initMusic(content));
