/* Edit content here. No password, secret key or build step is needed. */
window.CLUB_CONTENT = {
  joinUrl: "https://forms.gle/kwnmuuC9N77aHMzGA",
  records: [
    {
      id: "studio",
      name: { vi: "Góc sáng tạo", en: "Creative corner" },
      caption: { vi: "ĐĨA 01 · XANH STUDIO", en: "SIDE 01 · STUDIO GREEN" },
      spec: { vi: "LP · 33⅓ RPM · PLAYLIST 01", en: "LP · 33⅓ RPM · PLAYLIST 01" },
      theme: "green",
    ...
    },
    {
      ...
      spec: { vi: "LP · 33⅓ RPM · PLAYLIST 02", en: "LP · 33⅓ RPM · PLAYLIST 02" },
      theme: "pink",
  ...
  lyrics: {
    ...
    onlineSearch: true,
    // Optional exact per-track mappings; see HUONG-DAN.md.
    // "spotify:track:YOUR_TRACK_ID": {
    //   title: "Song title", artist: "Artist",
    //   lrc: "lyrics/your-authorized-lyrics.lrc"
    // }
    tracks: {}
  }
};
