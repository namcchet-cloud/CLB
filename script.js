...
(() => {
  ...
  window.ClubMotion={version:'3.2.0',burst,flyRecord,animate,register,setChoice,get enabled(){return enabled;},get choice(){return choice;}};
...
/* Music v3 moved to js/music-v3.js. */
...
(() => {
 ...
 window.ClubDiagnostics=()=>({
   ...
   turntable:window.ClubMusicV3?.state
 });
})();

window.ClubBuild='3.2.0';