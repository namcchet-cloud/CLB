const CACHE_VERSION = 'clb-v7.0.7';
const CORE = [
  './', './index.html', './legal.html', './site.webmanifest',
  './css/tokens.css?v=7.0.7', './css/site.css?v=7.0.7', './css/music.css?v=7.0.7', './css/intro.css?v=7.0.7', './css/comic-decor.css?v=7.0.7', './css/effects.css?v=7.0.7',
  './js/core/bootstrap.js?v=7.0.7', './js/core/build.js?v=7.0.7', './js/core/runtime.js?v=7.0.7', './js/core/i18n.js?v=7.0.7', './js/core/images.js?v=7.0.7', './js/core/pwa.js?v=7.0.7',
  './js/data/content.js?v=7.0.7', './js/data/images.js?v=7.0.7', './js/data/translations.js?v=7.0.7', './js/app.js?v=7.0.7',
  './js/features/motion.js?v=7.0.7', './js/features/navigation.js?v=7.0.7', './js/features/comic-decor.js?v=7.0.7', './js/features/gallery.js?v=7.0.7', './js/features/akiko.js?v=7.0.7', './js/features/raven.js?v=7.0.7',
  './js/features/music/index.js?v=7.0.7', './js/features/music/motor.js?v=7.0.7', './js/features/music/spotify.js?v=7.0.7',
